...
- [X] Explain what a token is used for.
  ...
  JWT is used for the purposes of user authentification.

- [X] What steps can you take in your web apps to keep your data secure?

  Add auth to your endpoints, make parts of your app inaccessible without authentification, validate user inputs.

- [X] Describe how web servers work.

  They communicate using a slew of technologies depending on each other. TCP/IP, DNS, HTTP.
